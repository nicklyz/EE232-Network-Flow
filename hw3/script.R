...
community_propagation1 <- label.propagation.community(ug1, weights=E(ug1)$Weight)
...
community_fastgreedy2 <- fastgreedy.community(ug2, weights = E(ug2)$Weight)
modularity(community_fastgreedy2)
sizes(community_fastgreedy2)
#label.propagation.community
community_propagation2 <- label.propagation.community(ug2, weights=E(ug2)$Weight)
modularity(community_propagation2)
sizes(community_propagation2)
